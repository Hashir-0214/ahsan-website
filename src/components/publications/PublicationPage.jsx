  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50/30 to-white pb-20 pt-32">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h1 className="text-2xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#8a48e7] to-[#5c21d2] mb-6">
            OUR PUBLICATIONS
          </h1>
            ...
            >
              ...
              >
                ...
                <div className="lg:w-2/5 relative overflow-hidden">
                  <div className="relative h-80 lg:h-full">
                    ...
                    <div className="absolute top-6 left-6">
                      <span className="px-4 py-2 bg-white/95 backdrop-blur-sm text-[#8a48e7] text-sm font-bold rounded-full shadow-lg">
                ...
                <div className="lg:w-3/5 p-8 lg:p-12 flex flex-col justify-center">
                  <h2 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-4 group-hover:text-[#8a48e7] transition-colors">
                    {publication.title}
                  </h2>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link href={publication.link}>
                      <motion.button
                        whileTap={{ scale: 0.95 }}
                        className="flex items-center gap-2 px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-xl font-semibold hover:border-[#8a48e7] hover:text-[#8a48e7] transition-all duration-300"
                      >
