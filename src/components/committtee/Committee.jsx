    ...
    <div className="mb-36 max-w-5xl mx-auto px-6 pt-36">
      ...
      >
        <div className="text-center mb-12">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-[#16a741] to-[#1FA447] mx-auto rounded-full mb-1 md:mb-4"></div>
            ...
            >
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-purple-100">
                ...
                <div className="p-3 text-center relative">
                  <div className="">
                    <h3 className="text-[12px] line-clamp-1 uppercase md:text-md poppins-bold text-gray-800 group-hover:text-[#16a741] transition-colors">
                      {member.name}
                    </h3>
                    <p className=" text-[10px] line-clamp-1 md:text-xs poppins-semibold text-[#16a741] uppercase tracking-wider">
                      {member.position}
                    </p>
                  </div>
                </div>
      ...
      >
        <div className="text-center mb-16">
          <h2 className="text-2xl md:text-4xl poppins-bold text-transparent bg-clip-text bg-gradient-to-r from-[#1FA447] to-[#16a741] mb-2 md:mb-4">
            WORKING COMMITTEE
          </h2>
          <div className="w-24 h-0.5 md:h-1 bg-gradient-to-r from-[#1FA447] to-[#16a741] mx-auto rounded-full mb-1 md:mb-4"></div>
          ...
          {workingCommittee.map((group, groupIndex) => (
            <div key={groupIndex} className="relative">
              ...
              >
                ...
                <h3 className="text-xs md:text-xl bg-[#1FA447] px-2 rounded poppins-bold text-white uppercase tracking-wide">
                  {group.role}
                </h3>
              ...
              >
                {group.members.map((member, memberIndex) => (
                  <motion.div
                    key={memberIndex}
                    whileHover={{ y: -8 }}
                    className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-purple-100 hover:border-[#16a741] w-auto md:w-64"
                  >
                    <div className="flex flex-col items-center p-4 md:p-6 text-center">
                      {/* Image */}
                      <div className="relative mb-4">
                        <div className="w-28 h-28 rounded-full overflow-hidden ring-4 ring-purple-50 group-hover:ring-[#16a741] transition-all duration-500">
                          <Image
                            src={member.image}
                            alt={member.name}
                            width={112}
                      ...
                      <div className="w-full">
                        <h3 className="text-sm md:text-lg poppins-bold text-gray-800 mb-3 group-hover:text-[#16a741] transition-colors">
                          {member.name}
                        </h3>
                      </div>
                    </div>
                    ...
                    <div className="h-1 bg-gradient-to-r from-[#16a741] to-[#1FA447] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-center" />
                  </motion.div>
                ))}
              </motion.div>
            </div>
