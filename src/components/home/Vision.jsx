...
export default function Vision() {
  const visionItems = [
    {
      icon: Award,
      text: "To cultivate enlightened, responsible, and skillful student leaders.",
    },
    {
      icon: TrendingUp,
      text: "To foster a vibrant campus culture rooted in knowledge, creativity, and values.",
    },
    {
      icon: Handshake,
      text: "To empower students with opportunities for holistic academic and personal growth.",
    },
    {
      icon: Lightbulb,
      text: "To build a collaborative community that serves society with excellence and integrity.",
    },
  ];
